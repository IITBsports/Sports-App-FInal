...
@Component({
  selector: 'app-indian-games',
  templateUrl: './indian-games.component.html',
  styleUrls: ['./indian-games.component.css']
})
export class IndianGamesComponent implements OnInit {
  sport: string;
  image: String;
  details: string;
