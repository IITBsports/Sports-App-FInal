...
export class RefreshPageService {
  ...
  getAvsBScores() {
    let API_URL = `http://10.198.49.8:8080/getAvsBScores`;
    return this.httpClient.get<any>(API_URL).pipe(
      map((res: Response) => {
        return res || {};
      })
  ...
  getCricketScores() {
    let API_URL = `http://10.198.49.8:8080/getCricketScores`;
    return this.httpClient.get<any>(API_URL).pipe(
      map((res: Response) => {
        return res || {};
      })
  ...
  getPoints() {
    let API_URL = `http://10.198.49.8:8080/getPoints`;
    return this.httpClient.get<any>(API_URL).pipe(
      map((res: Response) => {
        return res || {};
      })
  ...
  getPts() {
    let API_URL = `http://10.198.49.8:8080/getPts`;
    return this.httpClient.get<any>(API_URL).pipe(
      map((res: Response) => {
        return res || {};
      })
  ...
  getInteriitPts() {
    let API_URL = `http://10.198.49.8:8080/getInteriitPts`;
    return this.httpClient.get<any>(API_URL).pipe(
      map((res: Response) => {
        return res || {};
      })
  ...
  //   let API_URL = `http://10.198.49.8:8080/getSingleEvent`;
  ...
  GetEvent(id: String): Observable<any> {
    ...
    // return this.httpClient.get(`http://10.198.49.8:8080/api/getEvent/`+id, { headers: this.httpHeaders })
  }
